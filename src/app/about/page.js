...
export default function About() {
  return(
    <>
    <h1 className="bg-red-300 text-center">O mnie</h1>
    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Id harum doloremque provident officia! Veritatis beatae vel quod optio porro corporis sapiente consequatur asperiores, ullam exercitationem illo perspiciatis deserunt expedita nam?
    Consequuntur, laborum. Tempore aliquam tenetur aut. Enim sint, laborum exercitationem deserunt possimus fugiat tempora at debitis eveniet voluptate dolorum natus aliquam nam adipisci inventore velit! Rerum accusamus aliquid dicta quidem!
